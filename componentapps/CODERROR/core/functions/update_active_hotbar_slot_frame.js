...
export default function(){
	if(window.CODERROR.__originals__.data.save.player.interface.hotbar.slot_count==0)return;
	...
	document.querySelector(`.hotbar_slot[data-index="${window.CODERROR.__originals__.data.save.player.interface.hotbar.active_slot_index}"]`).appendChild(active_hotbar_slot_frame);
}
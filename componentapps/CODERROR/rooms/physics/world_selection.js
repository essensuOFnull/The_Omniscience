f.prepare(()=>{
	...
	window.CODERROR.__originals__.data.save.temp.room.data.div1.appendChild(f.get_symbolic_hr());
	window.CODERROR.__originals__.data.save.temp.room.data.div1.appendChild(f.get_br());
	window.CODERROR.__originals__.data.save.temp.room.data.div1.appendChild(window.CODERROR.__originals__.data.save.temp.room.data.worlds_list_div);
	...
	f.add_event_listener('get_json',window.CODERROR.__originals__.data.save.temp.room.data.drop_zone,(world)=>{
	...
	window.CODERROR.__originals__.data.save.temp.room.data.buttons.create.addEventListener('click',()=>{
		let name=prompt(window.CODERROR.__originals__.data.language.prompts.enter_world_name);
		if(name===null){
			return;
		}
		let world={

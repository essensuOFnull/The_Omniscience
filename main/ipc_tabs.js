...
export default function () {
    ipcMain.on('desktop_create', (event) => global.$.tab_create(`file:///${global.paths.desktopIndex}`, 'desktop',global.paths.desktopPreload));
    ipcMain.on('tab_create', (event) => global.$.tab_create(global.config.homepageUrl, 'web',global.paths.webtabPreload));
    ipcMain.on('xterm_create', (event) => global.$.tab_create(`file:///${global.paths.xtermIndex}`, 'xterm',global.paths.xtermPreload));
